...
const CARDS = [
  {
    title: 'ロール',
    body: [
      '編集者は数値分析、画像リサイズ、使い方を使えます。ヘッダーのメールアドレスからマイページを開き、自分のパスワードを変更できます。',
  ...
  },
  {
    ...
    body: [
      ...
      '比率は維持され、必要に応じて余白が付きます。自分の履歴からダウンロードできます。管理者は全ユーザーの全履歴も確認できます。',
    ],
  },
  {
    title: 'マイページ',
  ...
  },
  {
    title: 'ユーザー（管理者）',
    body: [
      '管理者と編集者の一覧、追加、ロール変更、無効化ができます。最終セッション、7日セッション、直近の操作も確認できます。',
